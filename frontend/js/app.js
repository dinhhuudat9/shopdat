...
class App {
    ...
    initRouter() {
        this.router = new Router([
            ...
            { path: '/hotro', page: '/pages/congdong.html', script: '/js/pages/congdong.js', auth: true },
            ...
            { path: '/vongquay', page: '/pages/vongquay.html', script: '/js/pages/vongquay.js', auth: true },
            { path: '/diemdanh', page: '/pages/diemdanh.html', script: '/js/pages/diemdanh.js', auth: true },
